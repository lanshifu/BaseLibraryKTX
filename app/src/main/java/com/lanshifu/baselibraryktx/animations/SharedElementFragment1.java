...
public class SharedElementFragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.activity_sharedelement_fragment1, container, false);
    ...
    private void addNextFragment(Sample sample, ImageView squareBlue, boolean overlap) {
        ...
        getFragmentManager().beginTransaction()
                ...
                .addSharedElement(view.findViewById(R.id.btnPre),"btnPre")
                .addSharedElement(view.findViewById(R.id.btnPlay),"btnPlay")
                .addSharedElement(view.findViewById(R.id.btnNext),"btnNext")
                .commit();
    }
